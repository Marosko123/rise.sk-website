  ...
  return (
    <section className="hero-gradient min-h-screen flex items-center justify-center pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">          {/* Main headline */}
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-[var(--foreground)] mb-6 leading-tight">
            {t('title')}
            <span className="text-[var(--primary)] block">{t('titleHighlight')}</span>
          </h1>
          ...
          <div className="mt-16 pt-8 border-t border-[var(--border)]">
            <p className="text-sm text-[var(--accent)] mb-4">Trusted by innovative companies</p>
