        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left side - Content */}          <div>
            ...
            <p className="text-lg text-[var(--neutral-dark)] mb-6 leading-relaxed">
              {t('description')}
            </p>            <p className="text-lg text-[var(--neutral-dark)] mb-8 leading-relaxed">
              {t('secondDescription')}
            </p>
              {/* Stats */}
            <div className="grid grid-cols-3 gap-6 mb-8">
              <div className="text-center">
                ...
                <div className="text-sm text-[var(--accent)]">{t('projectsDelivered')}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-[var(--primary)] mb-2">5+</div>
                <div className="text-sm text-[var(--accent)]">{t('yearsExperience')}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-[var(--primary)] mb-2">100%</div>
                <div className="text-sm text-[var(--accent)]">{t('clientSatisfaction')}</div>
              </div>
            </div>
          </div>
            {/* Right side - Quote */}
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-[var(--border)]">            <blockquote className="text-xl text-[var(--neutral-dark)] italic mb-6 leading-relaxed">
              &ldquo;{t('quote')}&rdquo;
            </blockquote>
            <div className="flex items-center">
              ...
              <div>
                <div className="font-semibold text-[var(--foreground)]">{t('founderName')}</div>
        ...
        <div className="mt-16 pt-16 border-t border-[var(--border)]">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h4 className="text-xl font-semibold text-[var(--foreground)] mb-3">{t('webDevTitle')}</h4>
            ...
            <div className="text-center p-6">
              ...
              <h4 className="text-xl font-semibold text-[var(--foreground)] mb-3">{t('designTitle')}</h4>
              <p className="text-[var(--neutral-dark)]">
                {t('designDesc')}
              </p>
            </div>
            <div className="text-center p-6">
              ...
              <h4 className="text-xl font-semibold text-[var(--foreground)] mb-3">{t('performanceTitle')}</h4>
              <p className="text-[var(--neutral-dark)]">
                {t('performanceDesc')}
              </p>
            </div>
