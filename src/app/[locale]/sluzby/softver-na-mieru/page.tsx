...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const localePath = locale === 'sk' ? '/sluzby/softver-na-mieru' : '/services/custom-software-development';
  const localeCode = locale === 'sk' ? 'sk_SK' : 'en_US';
  const canonicalUrl = locale === 'sk'
    ? 'https://rise.sk/sluzby/softver-na-mieru'
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        'sk': 'https://rise.sk/sluzby/softver-na-mieru',
