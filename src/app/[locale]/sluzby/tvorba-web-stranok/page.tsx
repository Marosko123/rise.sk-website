...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const localePath = locale === 'sk' ? '/sluzby/tvorba-web-stranok' : '/services/web-development';
  const localeCode = locale === 'sk' ? 'sk_SK' : 'en_US';
  const canonicalUrl = locale === 'sk'
    ? 'https://rise.sk/sluzby/tvorba-web-stranok'
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        'sk': 'https://rise.sk/sluzby/tvorba-web-stranok',
